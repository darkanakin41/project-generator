...
entry_points = {
    'console_scripts': [
        'project-generator = generator.__main__:console_script'
    ]
}

with io.open('generator/__version__.py', 'r') as f:
    version = re.search(r'^__version__\st*=\s*[\'"]([^\'"]*)[\'"]$', f.read(), re.MULTILINE).group(1)

args = dict(name='darkanakin41-project-generator',
            version=version,
            description='project-generator - Simplify project generation !',
            ...
            keywords='project generator project-generator',
            author='Pierre LEJEUNE',
            author_email='darkanakin41@gmail.com',
            url='https://github.com/darkanakin41/project-generator',
            license='MIT',
